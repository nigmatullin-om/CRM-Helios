...
public class CompanyUpdatePreparedStatementSetter implements PreparedStatementSetter {
    private static final Logger LOGGER = LogManager.getLogger(CompanyUpdatePreparedStatementSetter.class);
    ...
    public CompanyUpdatePreparedStatementSetter(Company company) {
