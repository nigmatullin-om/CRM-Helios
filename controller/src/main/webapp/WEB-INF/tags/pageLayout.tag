    ...
    <footer>
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9" align="right">
                <input type="button" value="RUS" class="btn btn-default flag flag-ru" onclick="SetCookie('localeCookie','ru_RU')"/>
                <input type="button" value="USA" class="btn btn-default flag flag-us" onclick="SetCookie('localeCookie','en_US')"/>
            </div>
        </div>
    </footer>
</div>
